...
void CoordinateSystemsDepth::changedepth(bool checked)
{
    m_depthEnabled = checked;
    update();
}
QWidget *CoordinateSystemsDepth::createControlPanel()
{
    QWidget *panel = new QWidget();
    QVBoxLayout *layout = new QVBoxLayout(panel);
    QCheckBox *use_depth_test = new QCheckBox("Use Depth Test", this);
    layout->addWidget(use_depth_test);
    QSpacerItem *verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
    layout->addItem(verticalSpacer);
    connect(use_depth_test, &QCheckBox::clicked, this, &CoordinateSystemsDepth::changedepth);
    return panel;
}
// 显示当前被点击按钮的名称
